...
Grimm.prototype = {
  handler: function (data) {
    ...
    return function (req, res) {
      ...
      // FIXME: this nastiness needs to be done right now because the files get
      // compiled and the values for partials become functions instead of paths
      // to files; moving away from whiskers might solve this...? jkalis
